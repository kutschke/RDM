...
this includes two elements, the Event Window Tag (EWT) and the EventMode, which will be discussed below.
...
In addition there will be several calibration modes.
...
\fixme{ So far as I know the mechanics of mapping EWT to EventID
  ...
  If not, who will write it up in a reference-able way?
}
...
\fixme{If the collaboration has a preference, they should make it know.}
...
\fixme{confirm that there are no {\code artdaq::DataLogger} processes involved and
that the DLLS is NSF mounted to this server.}
